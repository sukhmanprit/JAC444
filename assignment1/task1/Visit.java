...
public class Visit {
    ...
    public String toString() {
    	return String.format("[fullName = %s, member = %s, memberType = %s, date = %s]", this.customer.getName(), String.valueOf(this.customer.isMember()), this.customer.getMemberType(), String.valueOf(date) );
    }
